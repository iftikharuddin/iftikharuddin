...
- Researching Cross chain protocols, **Oracles, AMM, Vaults, DAOs, DEX, Cosmos SDK, OP Stack, Governance, Timelocks**.
...
- **Currently auditing**: 🔴 Tensor Protocol (Rust*) -> ... next maybe secure3 private or zkSync?
